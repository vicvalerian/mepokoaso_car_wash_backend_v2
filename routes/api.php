...
Route::group(['middleware' => ['auth:karyawan-api'] ], function() {
    ...
    Route::post('profil/karyawan', 'Api\KaryawanController@updateProfil');
    Route::post('profil/photo/karyawan', 'Api\KaryawanController@updateFoto');
    Route::post('profil/password/karyawan', 'Api\KaryawanController@updatePassword');
    Route::get('profil/karyawan', 'Api\KaryawanController@getProfilByUserLogin');
